...
interface FastRewindIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
}

const FastRewindIcon: React.FC<FastRewindIconProps> = ({
  size = 24,
  color = "#000",
  ...props
}) => (
  ...
  >
    ...
    <g transform="scale(-1, 1) translate(-256.409, 0)">
      <path
        className="cls-1"

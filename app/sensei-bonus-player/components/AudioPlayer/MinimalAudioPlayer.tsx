...
interface MinimalAudioPlayerContainerProps {
  borderRadius?: number;
  maxWidth?: number;
}

const MinimalAudioPlayerContainer =
  styled.div<MinimalAudioPlayerContainerProps>(
...
const MinimalAudioPlayer: React.FC = () => {
  ...
  return (
    <MinimalAudioPlayerContainer {...audioPlayerContainerStyles}>
      <LogoText {...logoTextStyles}>SENSEI BONUS</LogoText>

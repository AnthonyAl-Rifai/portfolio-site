...
export class PlayerEventEmitter<
  L extends PlayerListeners = PlayerListeners,
> extends EventEmitter {
  override emit<E extends PLAYER_EVENTS>(
    event: E,
    ...args: E extends keyof PlayerListeners ? Parameters<L[E]> : any[]
  ) {
    return super.emit(event, ...args);
  }

  override on<E extends PLAYER_EVENTS>(
    event: E,
  ...
  override off<E extends PLAYER_EVENTS>(
    event: E,
    listener: E extends keyof PlayerListeners ? L[E] : (...args: any[]) => void
  ) {
  ...
  override once<E extends PLAYER_EVENTS>(
    event: E,
    listener: E extends keyof PlayerListeners ? L[E] : (...args: any[]) => void
  ) {

    ...
    <Section id="music" ref={sectionRef} className="h-auto">
      ...
      <div className="relative">
        ...
        <div className="sticky top-[calc(2*var(--layout-size))] z-20 bg-white">
          ...
          >
            <h3 className="row-start-1 col-span-3 text-xl">
              ...
              electronic body music, finding truth in the controlled chaos of
              punk and techno. Born from the instinctual yearn for dark, crowded
        ...
        <div className="relative h-[125vh]">
          {/* This creates the scroll space while keeping the content sticky */}
        </div>
      </div>

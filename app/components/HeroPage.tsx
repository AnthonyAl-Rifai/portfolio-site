...
export default function HeroPage() {
  return (
    <>
      <h1 className="text-6xl font-bold row-start-2 col-span-full row-span-full sm:flex md:block">
        <span className="block overflow-hidden">
          <span className="block overflow-hidden animate-reveal-from-bottom">
